...
export const Payroll = lazy(() => import("../pages/hr/Payroll"));
export const Performance = lazy(() => import("../pages/hr/Performance"));
...
export const SupplierPayments = lazy(() => import("../pages/procurement/VendorBills"));
